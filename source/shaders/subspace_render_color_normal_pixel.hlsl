...
static float3 LightPosition = { 0.0f, 0.0f, -1.0f };

static float AmbientCoefficient = 0.65f;
static float SpecularStrength = 0.15f;
static float SpecularExponent = 256.0f;
...
float4 main(PixelShaderInput IN) : SV_Target
{
	...
	float3 DiffuseColor = 0.5f * DiffuseCoefficient * LightColor;
